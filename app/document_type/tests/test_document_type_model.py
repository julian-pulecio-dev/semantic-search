...
class DocumentTypeModelTest(TestCase):
    ...
    def test_authority_score_validation_lower_bound(self):
        """Test that creating a DocumentType with an authority_score below 0.0
    ...
    def test_default_authority_score(self):
        """Test that the default authority_score is set to 0.5 if not
        provided."""
    ...
    def test_str_representation(self):
        """Test that the string representation of a DocumentType instance is
        correct."""
